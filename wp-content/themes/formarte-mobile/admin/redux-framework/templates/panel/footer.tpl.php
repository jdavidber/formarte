    ...
    <div id="redux-footer">
        ...
        <div class="redux-action_bar">
            ...
            <?php if ( false === $this->parent->args['hide_save'] ) : ?>
                <?php submit_button( __( 'Save Changes', 'nightly-mobile' ), 'primary', 'redux_save', false ); ?>
            <?php endif; ?>

            <?php if ( false === $this->parent->args['hide_reset'] ) : ?>
                <?php submit_button( __( 'Reset Section', 'nightly-mobile' ), 'secondary', $this->parent->args['opt_name'] . '[defaults-section]', false, array( 'id' => 'redux-defaults-section' ) ); ?>
                <?php submit_button( __( 'Reset All', 'nightly-mobile' ), 'secondary', $this->parent->args['opt_name'] . '[defaults]', false, array( 'id' => 'redux-defaults' ) ); ?>
            <?php endif; ?>

        </div>

        <div class="redux-ajax-loading" alt="<?php _e( 'Working...', 'nightly-mobile' ) ?>">&nbsp;</div>
        <div class="clear"></div>
