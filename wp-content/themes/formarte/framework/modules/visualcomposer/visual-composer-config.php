...
if ( ! function_exists('oxides_edge_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function oxides_edge_configure_visual_composer() {
	...
	add_action('vc_after_init', 'oxides_edge_configure_visual_composer');

}

if ( ! function_exists('oxides_edge_configure_visual_composer_grid_elemets') ) {
	...
	function oxides_edge_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'oxides_edge_configure_visual_composer_grid_elemets');
}

if ( ! function_exists('oxides_edge_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function oxides_edge_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'oxides_edge_configure_visual_composer_frontend_editor');
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_Edgtf_Carousel_With_Image_And_Text extends WPBakeryShortCodesContainer {}
}
...
/*** Row ***/
if ( ! function_exists('oxides_edge_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function oxides_edge_vc_row_map()
	{
		...
		vc_add_param("vc_row", array(
			...
			"value" =>  "CLICK HERE TO SEE MORE CONTENT",
			"save_always" => true,
			"description" => "Default label is CLICK HERE TO SEE MORE CONTENT",
		...
		vc_add_param("vc_row", array(
			...
			"value" =>  "CLICK TO HIDE",
			"save_always" => true,
			"description" => "Default label is CLICK TO HIDE",
			"dependency" => Array('element' => "row_type", 'value' => array('expandable'))
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => 'Set Columns To Same Height',
	...
	add_action('vc_after_init', 'oxides_edge_vc_row_map');
}
