...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $oxides_edgeFramework, $edgt_options;
        ...
        if(edgt_core_theme_installed()) {
            $menuPosition = $oxides_edgeFramework->getSkin()->getMenuItemPosition('portfolio');
            $menuIcon = $oxides_edgeFramework->getSkin()->getMenuIcon('portfolio');
