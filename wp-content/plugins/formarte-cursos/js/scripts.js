...
document.onreadystatechange = function(e)
{
  if(document.readyState=="interactive")
  {
      if(document.getElementById('filtrosContainer')){
         var all = document.getElementById('filtrosContainer').children; 
      }else{
          var all = document.getElementById('listaCursos').children;
      }
...
function check_element(ele)
{
  ...
  if($(ele).on())
  {
    ...
    $("#bar1").animate({width:prog_width+"%"},10,function(){
      ...
      {
        $(".filtrosContainer").css("opacity", "1");
        $(".breadcrumbs").css("opacity", "1");
        $("#listaCursos").css("opacity", "1");
...
function cargarCursos(){
    if(ciudad.value == 'MEDELLIN')
    {
        $('#programa')
            ...
            .val('PSB')
            .append('<option value="PMR">Premédico Pre U. de A</option>')
            .val('PMN')
        ...
        if(ciudad.value == 'BOGOTA')
        {
            ...
            .append('<option value="PIR">Preingeniero</option>')
            .val('PIR')
            .append('<option value="PMR">Premédico Pre UNAL</option>')
            .val('PMR')
            .append('<option value="INS">Preuniversitario integrado UNAL ICFES 11°</option>')
            .val('INS')
        ...
        if(ciudad.value == 'BARRANQUILLA')
        {
            ...
            .append('<option value="PSB">PreICFES Saber 11°</option>')
            .val('PSB')
            .append('<option value="PSB">Preuniversitario U. del Atlántico</option>')
            .val('PSB')
            .append('<option value="PSB">Preuniversitario U. de Magdalena</option>')
            .val('PSB')
            .append('<option value="PUC">Preuniversitario U. de Cartagena</option>')
            .val('PUC')
        ...
        if(ciudad.value == 'BUCARAMANGA')
        {
            ...
            .val('PMN')
            .append('<option value="PSB">Preuniversitario UIS</option>')
            .val('PSB')
            .append('<option value="CPF">Clases particulares</option>')
            .val('CPF');
            $('#programa').val('');
        ...
        if(ciudad.value == 'MANIZALES')
        {
            ...
            .append('<option value="PSB">PreICFES Saber 11°</option>')
            .val('PSB')
            .append('<option value="PSB">Preuniversitario U. de Caldas</option>')
            .val('PSB')
            .append('<option value="PMR">Premédico PreICFES Saber 11°</option>')
            .val('PMR')
            .append('<option value="ITP">Preuniversitario integrado UdeA UNAL ICFES 11°</option>')
            .val('INSF')
            .append('<option value="INS">Preuniversitario integrado UNAL ICFES 11°</option>')
            .val('INS')
            .append('<option value="CPF">Clases particulares</option>')
        ...
        if(ciudad.value == 'CALI')
        {
            ...
            .append('<option value="PSB">PreICFES Saber 11°</option>')
            .val('PSB')
            .append('<option value="PSB">Preuniversitario U. del Valle</option>')
            .val('PSB')
            .append('<option value="PSB">Preuniversitario U. del Cauca</option>')
            .val('PSB')
            .append('<option value="PMR">Premédico PreICFES Saber 11°</option>')
            .val('PMR')
            .append('<option value="INS">Preuniversitario integrado UNAL ICFES 11°</option>')
            .val('INS')
            .append('<option value="SBI">Preuniversitario integrado inglés ICFES</option>')
            .val('SBI')
            .append('<option value="CPF">Clases particulares</option>')
            .val('CPF');
            $('#programa').val('');
